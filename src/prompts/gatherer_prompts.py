...
{{{{
  "articles": [
    {{{{
      ...
      "category": "politics_policy" | "business_markets" | "sports" | "entertainment" | "world_affairs" | "viral_cultural"
    }}}}
  ]
}}}}
...
{{{{
  "articles": [
    {{{{
      "title": "Article headline",
      "summary": "2-3 sentence summary including significance and stage (e.g., 'FDA approved', 'Phase 3 trial', 'published in Nature')",
      "source_url": "https://...",
      "credibility_tier": 1-3 (1=official/primary, 2=major outlet, 3=blog/social),
      "published_date": "YYYY-MM-DD or null",
      "category": "medical_research" | "scientific_discoveries" | "legal_courts" | "regulatory_filings"
    }}}}
  ]
}}}}
